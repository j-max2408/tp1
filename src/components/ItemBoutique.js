  ...
  const ItemBoutique = (props) => {
    ...
    return (
     ...
     <div className='bg-black-2 no-scroll ' >
        <Navigation/>
       <img src={props.img} alt="Exposition le temps des Québécois" class="photo"/>
        ...
        <p class="description-details ">{props.desc}</p>
            ...
            <Link className="btn-item auction-btn mr-2" to={`/Boutique`} >  <i class="fa-solid fa-arrow-left-long"></i>    </Link>            
